...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 21589)), "D:\\Program Files\\bot\\aoai\\chatgpt-aoai\\app\\(dashboard)\\(routes)\\video\\page.tsx"],
...
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 73242)), "D:\\Program Files\\bot\\aoai\\chatgpt-aoai\\app\\(dashboard)\\error.tsx"],
    ...
    const pages = ["D:\\Program Files\\bot\\aoai\\chatgpt-aoai\\app\\(dashboard)\\(routes)\\video\\page.tsx"];
    
    const originalPathname = "/(dashboard)/(routes)/video/page"
    const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24275))
...
;// CONCATENATED MODULE: ./app/(dashboard)/(routes)/video/constants.ts
...
;// CONCATENATED MODULE: ./app/(dashboard)/(routes)/video/page.tsx
...
const VideoPage = ()=>{
    ...
    const [video, setVideo] = (0,react_.useState)();
    ...
    const onSubmit = async (values)=>{
        try {
            setVideo(undefined);
            const response = await axios/* default */.Z.post("/api/video", values);
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(heading/* Heading */.X, {
                ...
                icon: lucide_react/* FileAudio */.u$9,
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    ...
                    !video && !isLoading && /*#__PURE__*/ jsx_runtime_.jsx(empty/* Empty */.H, {
                        label: "No video files generated."
                    }),
...
/* harmony default export */ const page = (VideoPage);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\Program Files\bot\aoai\chatgpt-aoai\app\(dashboard)\(routes)\video\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [4410,6382,8460,5052,3149,2725,1621,5198,585,4067,2982,9134,5414], () => (__webpack_exec__(55025)));
