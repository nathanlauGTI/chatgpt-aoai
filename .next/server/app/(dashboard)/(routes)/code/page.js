...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 47613)), "D:\\Program Files\\bot\\aoai\\chatgpt-aoai\\app\\(dashboard)\\(routes)\\code\\page.tsx"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 13155)), "D:\\Program Files\\bot\\aoai\\chatgpt-aoai\\app\\(dashboard)\\layout.tsx"],
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 73242)), "D:\\Program Files\\bot\\aoai\\chatgpt-aoai\\app\\(dashboard)\\error.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 19037)), "D:\\Program Files\\bot\\aoai\\chatgpt-aoai\\app\\layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 83174))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["D:\\Program Files\\bot\\aoai\\chatgpt-aoai\\app\\(dashboard)\\(routes)\\code\\page.tsx"];
    
    const originalPathname = "/(dashboard)/(routes)/code/page"
    const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 84018))
...
var react_markdown = __webpack_require__(51061);
// EXTERNAL MODULE: ./node_modules/next/navigation.js
var navigation = __webpack_require__(59483);
// EXTERNAL MODULE: ./components/bot-avatar.tsx
var bot_avatar = __webpack_require__(11023);
// EXTERNAL MODULE: ./components/heading.tsx
var heading = __webpack_require__(30963);
// EXTERNAL MODULE: ./components/ui/button.tsx
var ui_button = __webpack_require__(96940);
// EXTERNAL MODULE: ./components/ui/input.tsx
var input = __webpack_require__(67623);
...
var ui_form = __webpack_require__(68467);
// EXTERNAL MODULE: ./lib/utils.ts
var utils = __webpack_require__(48379);
// EXTERNAL MODULE: ./components/loader.tsx
var loader = __webpack_require__(41990);
// EXTERNAL MODULE: ./components/user-avatar.tsx
var user_avatar = __webpack_require__(69634);
// EXTERNAL MODULE: ./components/ui/empty.tsx
var empty = __webpack_require__(55960);
...
;// CONCATENATED MODULE: ./app/(dashboard)/(routes)/code/constants.ts

const formSchema = lib/* object */.Ry({
    prompt: lib/* string */.Z_().min(1, {
        message: "Prompt is required."
    })
});

;// CONCATENATED MODULE: ./app/(dashboard)/(routes)/code/page.tsx
...
const CodePage = ()=>{
    ...
    const onSubmit = async (values)=>{
        try {
            ...
            const response = await axios/* default */.Z.post("/api/code", {
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            isLoading && /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                ...
                                children: /*#__PURE__*/ jsx_runtime_.jsx(loader/* Loader */.a, {})
                            }),
                            messages.length === 0 && !isLoading && /*#__PURE__*/ jsx_runtime_.jsx(empty/* Empty */.H, {
                                label: "No conversation started."
                            }),
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                className: "flex flex-col-reverse gap-y-4",
                                children: messages.map((message)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                        className: (0,utils.cn)("p-8 w-full flex items-start gap-x-8 rounded-lg", message.role === "user" ? "bg-white border border-black/10" : "bg-muted"),
                                        children: [
                                            message.role === "user" ? /*#__PURE__*/ jsx_runtime_.jsx(user_avatar/* UserAvatar */.Y, {}) : /*#__PURE__*/ jsx_runtime_.jsx(bot_avatar/* BotAvatar */.k, {}),
                                            /*#__PURE__*/ jsx_runtime_.jsx(react_markdown/* ReactMarkdown */.D, {
                                                components: {
                                                    pre: ({ node, ...props })=>/*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                            className: "overflow-auto w-full my-2 bg-black/10 p-2 rounded-lg",
                                                            children: /*#__PURE__*/ jsx_runtime_.jsx("pre", {
                                                                ...props
                                                            })
                                                        }),
                                                    code: ({ node, ...props })=>/*#__PURE__*/ jsx_runtime_.jsx("code", {
...
/* harmony default export */ const page = (CodePage);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\Program Files\bot\aoai\chatgpt-aoai\app\(dashboard)\(routes)\code\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [4410,6382,8460,5052,3149,2725,1621,5198,585,5155,1061,4067,2982,9134,5414,6824], () => (__webpack_exec__(17095)));
