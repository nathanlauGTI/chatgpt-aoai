...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 58058)), "D:\\Program Files\\bot\\aoai\\chatgpt-aoai\\app\\(dashboard)\\(routes)\\conversation\\page.tsx"],
...
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 73242)), "D:\\Program Files\\bot\\aoai\\chatgpt-aoai\\app\\(dashboard)\\error.tsx"],
    ...
    const pages = ["D:\\Program Files\\bot\\aoai\\chatgpt-aoai\\app\\(dashboard)\\(routes)\\conversation\\page.tsx"];
    
    const originalPathname = "/(dashboard)/(routes)/conversation/page"
    const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6283))
...
;// CONCATENATED MODULE: ./app/(dashboard)/(routes)/conversation/constants.ts
...
;// CONCATENATED MODULE: ./app/(dashboard)/(routes)/conversation/page.tsx
...
const ConversationPage = ()=>{
    ...
    const onSubmit = async (values)=>{
        try {
            ...
            const response = await axios/* default */.Z.post("/api/conversation", {
...
/* harmony default export */ const page = (ConversationPage);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\Program Files\bot\aoai\chatgpt-aoai\app\(dashboard)\(routes)\conversation\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [4410,6382,8460,5052,3149,2725,1621,5198,585,5155,4067,2982,9134,5414,6824], () => (__webpack_exec__(39382)));
